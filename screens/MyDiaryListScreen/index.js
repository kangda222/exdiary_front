...
import WritingDiaryScreen from '../WritingDiaryScreen';

const diaryList = false;

//const moveScreen = () => {
//    this.props.navigation.navigate('WritingDiaryScreen');
//}
        ...
        <View>
            { !diaryList ? // 일기 리스트가 존재하지 않으면
                <View style={styles.container2}>
                    ...
                    <Ionicons name='ios-add-circle-outline' size={50} onPress={()=>alert('ㅎㅎ')}/>
                </View>
